...
Now it will work when you run the commit. However, if the pre-commit fails, then the add will rollback. You will have to resolve the failures before adding again and then commiting. 
